      ...
      {articlePairs.map((ap, index) => {
        ...
        return (
          <List
            ...
            reverse={isEven}
          >
            <ListItem article={ap[0]} narrow={isEven} pathPrefix={pathPrefix} />
            <ListItem article={ap[1]} narrow={isOdd} pathPrefix={pathPrefix} />
          </List>
        );
      })}
    </ArticlesListContainer>
...
const ListItem: React.FC<ArticlesListItemProps> = ({
  ...
  return (
    <ArticleLink to={`${pathPrefix}${article.slug}`} data-a11y="false">
