...
const Article: Template = ({ pageContext, location }) => {
  ...
  const { article, authors, next, pathPrefix } = pageContext;
  ...
  return (
    <Layout location={location}>
      <ArticleSEO article={article} authors={[]} location={location} />
      ...
      <ArticleBody ref={contentSectionRef}>
        <MDX content={article.body.childMdx.body}>
          <ArticleShare />
        </MDX>
      </ArticleBody>
      ...
      {next.length > 0 && (
        <NextArticle narrow>
          ...
          <ArticlesNext articles={next} pathPrefix={pathPrefix} />
          <FooterSpacer />
        </NextArticle>
      )}
    </Layout>
